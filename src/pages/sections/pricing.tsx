...
const tiers = [
  {
    ...
    priceMonthly: 5,
    description: "The standard allows for you to create Endaoments and",
    cta: "Get Started",
    features: [
      "Create a crypto Endaoment",
      "Secured wallet",
      "Recieve dist",
      "Vel ipsa esseFund endaoments on chain",
            ...
            <div className="rounded-lg bg-gray-100 px-6 py-8 sm:p-10 lg:flex lg:items-center">
              <div className="flex-1">
                ...
                <div className="mt-4 text-lg text-gray-600">
                  The Endao protocol is free and open source to anyone who wants
                  to self custody their own assets.
